...
def licenseToODM(licenseList):
    odmLicense = None
    if 'Datenlizenz Deutschland - Namensnennung - Version 2.0' in licenseList:
        odmLicense = 'dl-de-by-2.0'
    elif 'Datenlizenz Deutschland - Namensnennung - Version 1.0' in licenseList:
...
class BraunschweigReader(CatalogReader):
    def info(self):
        return {
            'name': 'braunschweig_reader',
            'title': u'geoportal.braunschweig.de',
            'description': ''
        }
